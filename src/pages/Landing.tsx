...
const ProductCard = ({ product }: { product: typeof products[0] }) => {
  ...
  return (
    <motion.a
      ...
      className="group relative flex flex-col glass-card rounded-[2rem] overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-primary/20 cursor-pointer"
    >
      ...
      <div className="p-6 space-y-4 flex flex-col flex-grow">
        ...
        <div className="flex items-center justify-between mt-auto pt-4 border-t border-white/5">
          ...
          <div className="p-3 bg-[#25D366] text-white rounded-2xl glow-on-hover transition-all duration-300 group-hover:scale-110 shadow-lg shadow-green-500/20">
